...
export function ListOfEvents() {
  //const eventos = useSelector((aux) => aux.eventos);

  return (
    <Card>
      <h3 className="text-tremor-content-strong dark:text-dark-tremor-content-strong font-semibold">Listado de Eventos</h3>
      <Table className="mt-5">
        <TableHead>
          <TableRow>
            <TableHeaderCell>Descripcion</TableHeaderCell>
            <TableHeaderCell>Lugar</TableHeaderCell>
            <TableHeaderCell>FechaEvento</TableHeaderCell>
